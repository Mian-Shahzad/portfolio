...
const SocialSidebar = () => {
    return (
        <div className="social-sidebar-container">
            ...
            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="social-float-btn btn-fb group">
                <div className="social-icon-wrapper">
            ...
            <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="social-float-btn btn-li group">
                <div className="social-icon-wrapper">
